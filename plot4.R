plot4 <- function(){
  ...
  plotData$GlobalReactivePowerkW <- as.numeric(plotData$Global_reactive_power) / 1000
  ...
  par(mfrow=c(2,2))
  # 3. plot
  with(plotData,plot(DateTime, GlobalActivePowerkW, xlab="", ylab="Global Active Power",main="", type="l"))
  # 2. plot
  ...
  # 4. plot
  with(plotData,plot(DateTime, GlobalReactivePowerkW, xlab="datetime", ylab="Global_reactive_power",main="", type="l"))
